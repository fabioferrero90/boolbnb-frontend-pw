              ...
              >
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <select
                    ...
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 mb-7"
                    onChange={setFieldValue}
                  >
                    <option value="" className="block mb-2 text-sm font-medium">
                      Scegli un'opzione:
                    </option>
